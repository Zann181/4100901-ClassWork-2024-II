...
#define LED_PIN 8 // Pin 5 of GPIOA (Heartbeat)(Led que titila)
#define LED1_PIN 1 // Pin 0 of GPIOA
#define LED2_PIN 5 // El 1 es el pin del microcontrolador que se conecta al Morpho
